...
"0": {
            "on_demand": true,
            "disable_audio": false,
            "webrtc_port_min": 1000,
            "url": "rtsp://admin:123456@192.168.0.244:554/Streaming/channels/101"
        }
"1": {
            "on_demand": true,
            "disable_audio": false,
            "webrtc_port_min": 1000,
            "url": "rtsp://admin:123456@192.168.0.151:554/Streaming/channels/101"
        },
        "2": {
            "on_demand": true,
            "disable_audio": false,
            "webrtc_port_min": 1000,
            "url": "rtsp://admin:123456@192.168.0.120:554/Streaming/channels/101"
        }
*/

// Config global
var Config *ConfigST //= loadConfig()
